...
console.info(props.showMoreButtonRefs.current)
    ...
    console.log("size right after creating is ", allReplyRefs.current.length )
    ...
    function Comment({ item, rows, showmore, setRows, userData, storyID, setArtDataComments, handleShowMoreButton, handleReplyButton}) {
        ...
        return (
            ...
            <>
                ...
                <CommentDisplay ref={addToRefs} className={"replies"} key={item.id + "commentDisplay"} showmore={showmore} item={item} id={item.id} >
