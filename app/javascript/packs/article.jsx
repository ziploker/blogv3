...
<img src={"none"}/>
<h3 style={{fontSize: ".6em", gridArea: "nick", marginRight: "8px"}}>mike</h3>

<CommentBody style={{gridArea: "body", fontSize: "15px"}}>sdvsdvsdv</CommentBody>

<Reply onClick={() => handleReplyButton(5)}>reply</Reply>
<VoteWrapper >
    <VoteUp>
